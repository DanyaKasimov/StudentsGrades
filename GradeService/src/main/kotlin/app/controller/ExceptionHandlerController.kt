...
class ExceptionHandlerController {
    ...
    fun handleIllegalArgumentException(ex: IllegalArgumentException): ResponseEntity<ApiErrorResponse> {
        log.warn("Обработка исключения IllegalArgumentException. Type: {}. Message: {}", ex.javaClass.simpleName, ex.message)
        return buildErrorResponse(HttpStatus.BAD_REQUEST, ex.message ?: "Неизвестная ошибка", ex)
    }
